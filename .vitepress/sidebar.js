  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        { text: '7.1.1前端部分', link: '/7.网络应用开发/7.1.1.1基础(三件套).md' },
        { text: '7.1.2后端部分', link: '/7.网络应用开发/7.1.2.1基础部分.md' },
      ]
    },
    {
      text: "8.基础学科",
        ...
        { text: '7.网络应用开发入门', link: '/7.网络应用开发/7.网络应用开发入门' },
        {
          ...
          items: [
            { text: '7.1WEB开发入门', link: '/7.网络应用开发/7.1WEB开发入门' },
            {
              ...
              collapsed: true,
              items: [
                { text: '7.1.1.1基础(三件套)', link: '/7.网络应用开发/7.1.1.1基础(三件套)' },
                { text: '7.1.1.2进阶(小项目)', link: '/7.网络应用开发/7.1.1.2进阶(小项目)' },
