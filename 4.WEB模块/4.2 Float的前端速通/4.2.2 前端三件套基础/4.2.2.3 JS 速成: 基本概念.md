...
如果你已经熟练运用 Python 等脚本语言，接触了脚本语言的各种概念和坑，那么你就可以直接快速阅读 [The Modern JavaScript Tutorial (英文)](https://javascript.info/) 来了解 JS 语法和踩坑点，学完之后也推荐阅读一下 [4.2.2.5 JS 速成: 继承、DOM API 和异步](./4.2.2.5%20JS%20速成:%20继承、DOM%20API%20和异步.md), 这篇是本人的经验之谈，希望能帮到大家。
：：：
