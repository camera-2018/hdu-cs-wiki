...
class Node:
    def __init__(self, state, parent, action):
        self.state = state        # 存储该节点的迷宫状态（即位置）
...
source code:https://cdn.cs50.net/ai/2020/spring/lectures/0/src0/
...
答案：[Quiz 0 - CS50's Introduction to Artificial Intelligence with Python](https://cs50.harvard.edu/ai/2024/quizzes/0/)[Quiz 0 - CS50's Introduction to Artificial Intelligence with Python](https://cs50.harvard.edu/ai/2024/quizzes/0/)
