...
![alt text](/3.AI模块/static/QQ_1721389158056.png)
如果以八位精读量化权重矩阵，那么每个参数将只得到 1 byte。因此，我们只需要9 bytes就可以存储整个权重矩阵。
![alt text](/3.AI模块/static/QQ_1721389582129.png)
...
![alt text](/3.AI模块/static/QQ_1721399716867.png)
...
![alt text](/3.AI模块/static/QQ_1721403751862.png)
...
![alt text](/3.AI模块/static/QQ_1721404514237.png)
...
![alt text](/3.AI模块/static/QQ_1721407068321.png)
...
![alt text](/3.AI模块/static/QQ_1721785559240.png)
而bfloat16 的位分配如下：
...
以下是浮点数在pytorch中的类型表：
![alt text](/3.AI模块/static/QQ_1721785604190.png)
