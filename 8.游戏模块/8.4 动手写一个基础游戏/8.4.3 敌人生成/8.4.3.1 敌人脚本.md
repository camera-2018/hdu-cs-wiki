...
4. 将敌人预制体的 Layer 改为**Enemy**（新建 Enemy 图层），将玩家的 Layer 改为**Player**（新建**Player**图层）
5. 让玩家**Player Controller**继承 CharacterBase 类
...
当物体的碰撞体产生**物理碰撞**时，调用此方法，因此碰撞体不能为**触发器**（Trigger）

相关链接：[OnCollisionEnter2D](https://docs.unity.cn/cn/2019.4/ScriptReference/Collider2D.OnCollisionEnter2D.html)
